    ...
    <section className="section-cta u-spacing-inline">
      <div className="container">
        <div className="cta-card u-overflow-hidden u-stacking-context u-position-relative u-text-center u-color-typography-25">
          <img
            src="https://cdn.prod.website-files.com/682e10925e475b2f723fc5bc/68599defbfa86f41886e357e_logomark.svg"
            loading="lazy"
            width="60"
            height="60"
            alt="Leading Cards"
            className="cta-card_logo u-ratio-1"
          />
          ...
          <div className="u-display-flex u-justify-content-center" style={{ gap: '1rem', marginBottom: '2rem' }}>
            <button
              onClick={onOpenModal}
            ...
            {SOCIALS.map((s) => (
              <li key={s.alt}>
                <a href={s.href} target="_blank" rel="noreferrer" className="cta-card_list_link w-inline-block">
                  <img src={s.src} loading="lazy" width="50" height="50" alt={s.alt} className="cta-card_list_image u-ratio-1" />
                </a>
              </li>
            ))}
          </ul>
