...
const ICONS = [
  {
    ...
    style: {
      transform: "translate3d(910.421px, 441.927px, 0px) scale(0.0011)",
      opacity: 0.0011,
    },
  },
  {
  ...
  },
  {
    ...
    style: {
      transform: "translate3d(1591.75px, 80.4401px, 0px) scale(0.8039)",
      opacity: 0.8039,
    },
  },
  {
...
export default function IntegrationsSection() {
  ...
  useEffect(() => {
    const initAnimation = () => {
      ...
      Array.from(paths).forEach((path) => {
        ...
        const icon = sectionRef.current?.querySelector(
          `[data-icon="${iconName}"]`,
        );
        if (!icon) return;
  ...
  return (
    <section
      ref={sectionRef}
      className="section-integrations u-position-relative u-overflow-hidden u-spacing-block"
    >
      <div className="integrations_header u-spacing-inline u-text-center">
        <div style={{ marginBottom: "1.5rem" }} className="section-header">
          <div>
            <h2
              className="section-title heading-h2 u-text-color-dark u-text-center"
              style={{ maxWidth: "20ch" }}
            >
              <div>
                <span
                ...
                <span className="section-title-text cc-gradient">
                  business services
                </span>
                <span
                  className="section-title-text"
      ...
      <div className="integrations_elements u-select-none">
        <div className="u-display-grid u-position-relative">
          <svg
            ...
            width="1344"
            height="455"
            viewBox="0 0 1344 455"
            fill="none"
            className="integrations_elements_svg u-width-full u-mx-auto"
          >
            <g id="new-lines-group">
              <path
                id="Vector 8017"
                d="M1344 455H831.62C828.967 455 826.389 454.121 824.288 452.5L689.668 348.603C686.724 346.331 685 342.822 685 339.103V91"
                stroke="#DFE4EC"
                strokeLinecap="round"
              />
              <path
                id="Vector 8012"
                d="M0 455H512.274C514.926 455 517.503 454.122 519.602 452.502L654.328 348.603C657.274 346.331 659 342.821 659 339.1V90"
                stroke="#DFE4EC"
                strokeLinecap="round"
              />
              <path
            ...
            <g id="dot">
              {[
                ...
                <rect
                  ...
                  height="7"
                  rx="1.5"
                  transform={`matrix(-1 0 0 1 ${p.x * 2} 0)`}
                  fill="white"
                  stroke="#DFE4EC"
                />
              ))}
          ...
          {/* <svg
            ...
            viewBox="0 0 1344 455"
            fill="none"
            className="integrations_elements_svg cc-logo u-position-absolute u-width-full u-mx-auto"
          >
            <g id="Button">
              <g clipPath="url(#clip1_7001_789)">
                <g id="Badge">
                  ...
                  <path
                    d="M617 147C617 135.954 625.954 127 637 127H707C718.046 127 727 135.954 727 147V217C727 228.046 718.046 237 707 237H637C625.954 237 617 228.046 617 217V147Z"
                    fill="url(#paint0_linear_7001_789)"
                  />
                  <path
                    d="M615 147C615 134.85 624.85 125 637 125H707C719.15 125 729 134.85 729 147H725C725 137.059 716.941 129 707 129H637C627.059 129 619 137.059 619 147H615ZM727 237H617H727ZM637 237C624.85 237 615 227.15 615 215V147C615 134.85 624.85 125 637 125V129C627.059 129 619 137.059 619 147V217C619 228.046 627.059 237 637 237ZM707 125C719.15 125 729 134.85 729 147V215C729 227.15 719.15 237 707 237C716.941 237 725 228.046 725 217V147C725 137.059 716.941 129 707 129V125Z"
                    fill="#A96DFD"
                  ...
                  <g id="Group">
                    <path
                      id="Vector"
                      d="M679.344 206L670.882 191.273L661.887 175.609L666.119 168.236L672.003 158L680.168 172.226L676.766 178.149L672.003 169.857L668.697 175.609L673.732 184.375L682.746 200.071H689.34L685.488 193.338L688.89 187.416L699.563 206H679.344Z"
                      fill="white"
                    />
                    <path
                      id="Vector_2"
                      d="M644.437 206L658.607 181.335L662.008 187.257L658.961 192.571L654.648 200.065H669.356L672.763 206H644.437Z"
                      fill="white"
                    />
                  </g>
                </g>
          ...
          >
            ...
            {/* Logo ảnh của bạn */}
            <image
              xlinkHref="/Logo-uproadcards.svg"
              x="622"
              y="132"
              width="100"
              height="100"
        ...
        <div className="integrations_elements_icons u-position-absolute">
          {ICONS.map((icon) => (
            <div
              key={icon.name}
              data-icon={icon.name}
              className="integrations_elements_icon u-place-items-center u-display-grid u-ratio-1"
              style={icon.style}
            >
              <img
                src={icon.src}
                ...
                height="44"
                alt=""
                className="integrations_elements_icon_image"
              />
            </div>
          ))}
        </div>
      ...
      <div className="integrations_footer u-text-center u-spacing-inline u-display-grid">
        <img
          src="https://cdn.prod.website-files.com/682e10925e475b2f723fc5bc/687b3c4587646a040d347d81_apple-pay.svg"
          loading="lazy"
          width="103"
          height="62"
          alt=""
          className="integrations_footer_logo u-mx-auto"
        />
